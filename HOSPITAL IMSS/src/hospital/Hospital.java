...
public class Hospital {
    ...
    public void Hospital(){
        ...
        Administrador administrador = new Administrador("A1", "Pablo", "Gallegos", fechaNacimiento, "4466523641", "1234", Rol.ADMIN,10.000, "GAMP", 10);
    ...
    public void verConsultaPaciente (String idPaciente){
    ...
    public void generarExpedienteConsulta(String idConsulta,String idPaciente){
        ...
        if(consulta == null){
            System.out.println("No existe una una consulta con el Id proporcionado");
            return;
        }
