...
public class MenuAdministrador {
        ...
        switch (opcion) {
            case 1:
                ...
                if (!hospital.listaPacientes.isEmpty()) {
                    while (hospital.validarTelefoPacienteYaExiste(numeroTelefonoPaciente)) {
            ...
            case 2:
                ...
                if (!hospital.listaMedicos.isEmpty()) {
                    while (hospital.validarTelefoMedicoYaExiste(numeroTelefonoMedico)) {
                ...
                Medico medico = new Medico(idMedico,nombreMedico, apellidosMedico, fechaNacimientoMedico, numeroTelefonoMedico, rfc, contraseniaMedico);
    ...
    private ArrayList<String> obtenerDatosComun(Rol rol, Hospital hospital){
        ...
        System.out.println(String.format("Ingrese los datos del %s", tipoUsuario));
        System.out.println(String.format("Ingrese el nombre del %s", tipoUsuario));
        String nombre = sc.nextLine();
        datosEnComun.add(nombre);

        System.out.println(String.format("Ingrese los apellidos del %s", tipoUsuario));
    ...
    private String obtenerFechaNacimientoUsuario(String tipoUsuario) {
        ...
        while (!esFechaValida) {
            System.out.println(String.format("Ingrese el año de nacimiento del %s", tipoUsuario));
            int anio = sc.nextInt();
...
//validador de correo, pedir correo, agregar atributo a usuarios y este metodo agregarlo a hospital